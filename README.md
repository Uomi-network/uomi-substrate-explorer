...
1. Clone the repo locally, via `git clone https://github.com/Uomi-network/uomi-substrate-explorer <optional local path>`
...
For more details on the desktop app, head over to [Electron package README](https://github.com/Uomi-network/uomi-substrate-explorer/blob/master/packages/apps-electron/README.md).
